...
# Note: `context_compressor` is the Hermes v0.11 rename of
...
try:
    ...
    # Life OS vendors this Hermes component without the full Hermes runtime.
    # These fallbacks keep import/compile checks working; live LLM compression
    # still requires Hermes' `agent` package on PYTHONPATH.
    MINIMUM_CONTEXT_LENGTH = 64_000

    class ContextEngine:
        """Minimal compatibility shim for the vendored Hermes compressor."""
    ...
    def call_llm(*args: Any, **kwargs: Any) -> Any:
        raise RuntimeError(
            "Hermes `agent` package is required for live context compression."
        )
