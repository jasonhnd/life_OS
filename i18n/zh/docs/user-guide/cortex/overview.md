---
translated_from: docs/user-guide/cortex/overview.md
...
> **译注**:本文从 `docs/user-guide/cortex/overview.md` 同步,2026-04-22 由 auto-translation 流程完成。源文本已为中文,此处保留原文并补齐 i18n frontmatter。技术词(Cortex / Hippocampus / GWT / Narrator / Hebbian / Step 0.5 / Step 7.5 等)保留英文。若与 EN 原文出现漂移,以源文件为准。
