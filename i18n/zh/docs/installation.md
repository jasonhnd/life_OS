...
这是 Life OS 在 Claude 平台的完整形态：多个独立 AI 角色，真正的信息隔离和并行执行。
...
Pro 模式现已支持 [Gemini CLI](https://github.com/google-gemini/gemini-cli) 和 [Google Antigravity](https://idx.google.com/)，由 Gemini 2.5 Pro 驱动多个独立 subagent。
...
Pro 模式现已支持 [Codex CLI](https://github.com/openai/codex)，由 o3 驱动多个独立 subagent。
...
> **注意**：Life OS 需要 Pro 模式 —— 多个独立 subagent 和真正的信息隔离。单上下文平台（ChatGPT、Gemini 网页版、Claude.ai 网页版）不受支持。
