...
Method 候选由 `archiver` Phase 2（参见 `agents/archiver.md`）探测，使用与产出 wiki 和 SOUL 候选项相同的基础设施。
...
- `agents/archiver.md` —— 写入 method 候选（Phase 2）
- `agents/dispatcher.md` —— 将 methods 注入 domain brief
