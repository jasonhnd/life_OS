...
DREAM 是系统的离线记忆处理机制——灵感来自人类的睡眠周期。它作为**起居郎（`pro/agents/qiju.md`）的 Phase 3** 在每次退朝时运行，扫描过去 3 天的活动，进行整理、巩固和发现。

> **注意**：DREAM 不再是独立 agent。v1.4.4 起已融入起居郎。本规范定义三个阶段；起居郎将其集成到退朝流程中。
