...
affects: agents/concept-lookup.md + agents/soul-check.md
---
...
- `docs/architecture/v1.7-spec-map.md §6 · Create 3 new agent files` 明确只许 create 3 文件:
  1. agents/hippocampus.md
  2. agents/gwt-arbitrator.md
  3. agents/narrator-validator.md
- **事实**: `agents/concept-lookup.md` 和 `agents/soul-check.md` 均已存在且被 `hosts/CLAUDE.md` Step 0.5 wired in 作为独立 subagent
...
- `compliance/2026-04-21-narrator-spec-violation.md` — narrator handled separately via Option C (ROUTER-internal template, not a subagent)
- `hosts/CLAUDE.md §0.5` / `hosts/GEMINI.md §0.5` / `hosts/AGENTS.md §0.5` — Step 0.5 wiring (unchanged)
