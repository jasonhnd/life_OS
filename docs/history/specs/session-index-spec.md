...
The retrospective compiles — never writes per-session files. Extends the existing Mode 0 flow (see `agents/retrospective.md`):
...
- `agents/archiver.md` — writer of `{session_id}.md`, Phase 1 scope
- `agents/retrospective.md` — compiler of `INDEX.md`, Mode 0 Start Session responsibility
