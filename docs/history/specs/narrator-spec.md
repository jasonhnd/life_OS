...
> active and authoritative. Read `agents/narrator.md` for the
...
The narrator is inserted as **Step 7.5** in the hosts/CLAUDE.md workflow, after Step 7 Summary Report composition and before Step 8 AUDITOR:
...
A new subagent file is created: `agents/narrator-validator.md`.
...
- `agents/router.md` — narrator composition lives inside ROUTER (this spec §6)
