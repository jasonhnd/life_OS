...
AUDITOR Mode 3 (auto, per Orchestration rule #7):
  ...
  · Logs violations to compliance/violations.md or meta/compliance/violations.md
```
...
## 3. Information Isolation Matrix (per hosts/CLAUDE.md)
...
- `hosts/CLAUDE.md` Step 0.5 — orchestrator wiring
- `agents/{hippocampus,concept-lookup,soul-check,gwt-arbitrator,narrator,narrator-validator}.md` — subagent contracts
