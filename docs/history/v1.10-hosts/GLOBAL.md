...
- Do not handle backend storage tasks (git operations, version checks). Session-start reads belong to the RETROSPECTIVE agent; session-close writes belong to the ARCHIVER agent.
