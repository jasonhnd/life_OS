...
Life OS 里散落在 SKILL.md、hosts/CLAUDE.md、hosts/GLOBAL.md、agents/*.md 里的全部 HARD RULE, 汇总成一处。按类别组织,每条注明**出处**和**强制机制**。
...
**出处**: `SKILL.md` / `agents/router.md` 之 "Intent Clarification"
...
**出处**: `SKILL.md` / `agents/router.md` 之 "First Response Flow"
...
**出处**: `SKILL.md` / `hosts/CLAUDE.md` 之 "Session Binding" / `agents/router.md` 之 "Session Binding"
...
**出处**: `hosts/CLAUDE.md` Step 5 / `agents/router.md` 之 "Domain Reports Display"
...
**出处**: `SKILL.md` / `agents/router.md` 之 "STRATEGIST trigger"
...
**出处**: `hosts/CLAUDE.md` 之 "Orchestration Code of Conduct" #1 / `agents/reviewer.md`
...
**出处**: `agents/reviewer.md` 之 "SOUL Reference (HARD RULE — every decision)"
...
**出处**: `hosts/CLAUDE.md` Step 3 之 "Veto Correction Loop"
...
**出处**: `agents/reviewer.md` 之 "Veto format"
...
**出处**: `SKILL.md` / `hosts/CLAUDE.md` Step 10 / `agents/archiver.md` 之 "HARD RULE: Subagent-Only Execution"
...
**强制**: AUDITOR 检查 ROUTER 输出; `hosts/CLAUDE.md` Step 10 明确列出禁止行为。
...
**出处**: `agents/archiver.md` / `hosts/CLAUDE.md` Step 10
...
**出处**: `agents/archiver.md` Phase 1 / `references/data-layer.md` 之 Wrap-Up Mode
...
**出处**: `agents/archiver.md` / `hosts/CLAUDE.md` Adjourn State Machine
...
**内容**: 用户说 Start Session 触发词 (start / 上朝 / 开始 / はじめる 等) → ROUTER 必须读 `agents/retrospective.md` 并启动 RETROSPECTIVE 作为 subagent, Mode 0。ROUTER 不得自己输出任何步骤内容。

**出处**: `SKILL.md` / `hosts/CLAUDE.md` 之 "Trigger words MUST load agent files"
...
**出处**: `hosts/CLAUDE.md` / `hosts/GEMINI.md` / `hosts/AGENTS.md` 各自的 "CC/Gemini/Codex Environment Enforces Pro Mode"
...
**出处**: `hosts/CLAUDE.md` 之 "Orchestration Code of Conduct" #2
...
**出处**: `hosts/CLAUDE.md` / `hosts/GLOBAL.md` 之 "Research Process"
...
**出处**: `hosts/CLAUDE.md` 之 "Orchestration Code of Conduct" #4

**强制**: 见 TH4。

---

## 类别 6: GLOBAL 通用规则 (hosts/GLOBAL.md)

### GL1. 研究过程展示 (🔎/💭/🎯)

**内容**: 任何 agent 出结论前, 必须展示 Evidence (🔎 查了什么) / Considered options (💭 权衡什么) / Judgment (🎯 判断及依据) 三段。缺其一 = 违规。

**出处**: `hosts/GLOBAL.md` 之 "Research Process"
...
**出处**: `hosts/GLOBAL.md` 之 "Progress Reporting"
...
**出处**: `hosts/GLOBAL.md` 之 "Security Boundaries"
...
**出处**: `agents/archiver.md` 之 "Anti-patterns"
...
**出处**: `agents/retrospective.md` Mode 0 Phase B Step 7
...
**出处**: `agents/archiver.md` / `agents/advisor.md`
