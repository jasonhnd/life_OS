...
Method の候補は `archiver` Phase 2(`agents/archiver.md` 参照)で検出され、wiki と SOUL の候補を生成するのと同じインフラを使います。
...
- `agents/archiver.md` — method 候補を書き込む(Phase 2)
- `agents/dispatcher.md` — method を domain のブリーフに注入
