...
retrospective はコンパイルします — セッションごとのファイルは書きません。既存の Mode 0 フロー(`agents/retrospective.md` 参照)を拡張:
...
- `agents/archiver.md` — `{session_id}.md` の writer、Phase 1 スコープ
- `agents/retrospective.md` — `INDEX.md` の compiler、Mode 0 Start Session 責任
