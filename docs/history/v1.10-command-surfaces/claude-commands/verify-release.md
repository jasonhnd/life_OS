...
Run the following commands and paste their **literal stdout** (do not summarize or rewrite). Then evaluate the 11 checks below. **Any ❌ means the release is NOT done.**
