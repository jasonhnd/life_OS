...
Rebuild `meta/concepts/INDEX.md` (sorted by weight) and
`meta/concepts/SYNAPSES-INDEX.md` (one row per synapse edge) from per-concept
markdown files.
...
1. `Glob meta/concepts/**/*.md` (exclude INDEX.md and SYNAPSES-INDEX.md)
...
6. Write `meta/concepts/INDEX.md` with header `# Concepts index · auto-rebuilt {ISO8601}`
...
5. Write `meta/concepts/SYNAPSES-INDEX.md`

## Failure handling

- Malformed YAML → log to `meta/sync-log.md`, skip
