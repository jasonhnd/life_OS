...
4. **Agent definitions or theme files** — those are `agents/` and `themes/` exclusive territory.
...
1. Could a **rule** (in `hosts/CLAUDE.md` or SKILL.md) accomplish this?
...
6. Could a **human checklist** in `hosts/CLAUDE.md` accomplish this?
