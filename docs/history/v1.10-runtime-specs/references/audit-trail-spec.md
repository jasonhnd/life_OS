...
Historical `meta/runtime/<sid>/*.json` trail files from v1.8.5 and earlier:
...
| **`.json` or `.yml` file in `meta/runtime/<sid>/` (v1.8.6+)** | `F4-forbidden-extension-trail` | F4_SCOPE_FAILURE |
