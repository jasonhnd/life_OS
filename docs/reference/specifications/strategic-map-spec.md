...
2. **单一真相源**：`projects/{project}/index.md` frontmatter 存每项目战略数据；`meta/strategic-lines.md` 存战略线定义；`meta/STRATEGIC-MAP.md` 是编译产物（从不手工编辑）
...
```
1. 读 meta/strategic-lines.md → 所有线定义
