---
name: monitor
description: "Life OS Monitor mode (v1.8.0). Activated when user runs /monitor slash command. This subagent role manages cron automation, reports system status, helps user process action items from AUDITOR Patrol / ADVISOR monthly / strategic-consistency reports. Does NOT engage in business deliberation, does NOT trigger Cortex Pre-Router, does NOT run 上朝/退朝."
