...
> See `pro/CLAUDE.md` §"Decision Records" for full spec. Codex sync — same v1.9 schema applies.
...
> See `pro/CLAUDE.md` §"Minimality Rule" for full spec. Codex sync — same 6-question gate applies.
...
> See `pro/CLAUDE.md` §"Risk Domains" and `references/risk-domains.md` for full spec. Codex sync — same 8 domains apply.
