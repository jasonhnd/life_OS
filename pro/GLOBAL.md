...
- Do not handle backend storage tasks (Notion sync, git operations, version checks). Session-start reads belong to the RETROSPECTIVE agent; session-close writes belong to the ARCHIVER agent.
