...
### Message 1
- **Router**: Translate directly, no escalation, no follow-up questions
- Output should be the translation result, without the "Router - Presenting to Court" format

### Message 2
- **Router**: Must escalate
...
- Recommended domains should include at least FINANCE and GOVERNANCE
- Background summary should flag the FOMO signal in "if I don't buy now it'll be too late"

### Message 3
- **Router**: Two reasonable behaviors, both acceptable:
...
- **Not acceptable**: Escalating to court (a simple sleep issue doesn't need Six Domains analysis)
...
- [ ] Message 2: Recommended domains include FINANCE
