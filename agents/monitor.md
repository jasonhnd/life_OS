...
context_manifest:
  source_of_truth: [hosts/CLAUDE.md, hosts/GLOBAL.md, scripts/prompts/]
  supporting: [meta/queue/notifications.md, meta/eval-history/]
  forbidden: [agents/planner.md, agents/reviewer.md, agents/archiver.md (monitor is OPS, not business)]
blast_radius:
...
- `hosts/CLAUDE.md` → Session Modes (v1.8.0)
- `references/session-modes-spec.md` (deleted in v1.8.0 pivot — superseded by `hosts/CLAUDE.md` Session Modes)
