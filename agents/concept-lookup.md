...
context_manifest:
  ...
  forbidden: [agents/hippocampus.md, agents/soul-check.md, raw concept body content (only INDEX scan)]
blast_radius:
  allowed_scope: [meta/runtime/<sid>/concept-lookup-*.md]
  forbidden_scope: [SOUL.md, wiki/, agents/, meta/concepts/* body files]
failure_modes:
