...
blast_radius:
  allowed_scope: [meta/runtime/<sid>/gwt-arbitrator-*.md, [COGNITIVE CONTEXT] block emission to ROUTER]
...
Tuning protocol: see `meta/cortex/salience-tuning.md`.
