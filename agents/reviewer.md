...
context_manifest:
  ...
  forbidden:
    - agents/planner.md           # peer — receives planner's output, not internals
    - agents/archiver.md          # peer
    - agents/retrospective.md     # peer
    - agents/auditor.md           # peer (AUDITOR audits REVIEWER, not vice-versa)
blast_radius:
  allowed_scope:
  ...
  forbidden_scope:
    ...
    - agents/                     # agent defs never self-modify
...
failure_modes:
  ...
  repair_actions:
    ...
    - "Append violation row to compliance/violations.md with F-code"
---
