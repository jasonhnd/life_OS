...
context_manifest:
  source_of_truth: [hosts/CLAUDE.md, references/domains.md, references/risk-domains.md, references/compliance-spec.md, SOUL.md]
  supporting: [compliance/violations.md, wiki/INDEX.md (legal/security entries)]
...
blast_radius:
  ...
  forbidden_scope: [SOUL.md, wiki/, decisions/, agents/, files outside governance domain]
failure_modes:
