...
context_manifest:
  source_of_truth: [hosts/CLAUDE.md, hosts/GLOBAL.md, references/domains.md, references/scene-configs.md]
  supporting: [meta/STATUS.md]
  forbidden: [agents/planner.md, agents/reviewer.md, decisions/]
blast_radius:
  allowed_scope: [meta/runtime/<sid>/dispatcher-*.md]
  forbidden_scope: [SOUL.md, wiki/, agents/, decisions/, all domain-owned files]
failure_modes:
