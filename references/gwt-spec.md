...
- **Do not include raw subagent output** in the annotation. Consolidate to concept references and short summaries. Full payloads must still be pasted to the user and written to `meta/journal/{date}-cortex.md` for traceability; no frame md is used.
