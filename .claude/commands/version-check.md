...
| Local | Remote | Hint |
|-------|--------|------|
| `1.8.6` | `≥1.8.7` | `✅ v1.8.7 upgrade is zero-friction: git pull + /install-agents --refresh installs 2 new watch commands. archiver first wrap-up auto-creates pro/gotchas.md with ≥10 seed entries. No migration command needed. Details: meta/rfc/v1.8.7-openhuman-borrowed-patterns.md` |
